...
# fram = Frame(root, background="white")
# fram.place(height=900, width=1300, x=300, y=40)
...
def prducts_top(frame_prod):
    ...
    btn2 = Button(Frame_login, text="Products", cursor="hand2",command=lambda:prod_call(user),
                  font=("times new roman", 10), fg='white', bg='orangered', bd=0, width=15, height=1)
    btn2.place(x=30, y=10)

    """
    entry = Entry(Frame_login, background="black", cursor="hand2",`
                       font=("times new roman", 25), bg='white')
    entry.place(x=300, y=10, width=500, height=35)
    """
...
def cart_top(cart_root):
    ...
    """btn2 = Button(Frame_login, text=, cursor="hand2",command=cart_call,
                  font=("times new roman", 10), fg='white', bg='orangered', bd=0, width=12, height=1)
    btn2.place(x=1300, y=13)"""
...
class DynamicGrid1(tk.Frame):
    ...
    def add_box(self, var, color=None):
        ...
        label3 = tk.Label(box, text="Product description:", font=('times new roman', 15)
                          , fg='black').place(x=20, y=60)
        label4 = tk.Label(box, text=var[2], font=('times new roman', 15)
                          , fg='black').place(x=230, y=60)
        """
        label5 = tk.Label(box, text="Price:", font=('times new roman', 15)
                          , fg='black').place(x=20, y=60)
...
def add_cart():
    ...
    messagebox.showinfo(title="Success", message=f"your cart product successfully created")
    mydb.commit()
